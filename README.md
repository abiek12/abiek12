...
[![My Skills](https://skillicons.dev/icons?i=git,github,nodejs,docker,kubernetes,aws,bash,linux,kafka,pnpm,vscode,eclipse,md,mongodb,postgres,npm,postman,vercel,powershell,linux,notion,stackoverflow,&theme=dark&perline=10)](https://skillicons.dev)
